...
const testCases = [
    ...
    // 소수점
    { input: "1.5,2.5", expected: "4", shouldError: false },
    { input: "0.1,0.2,0.3", expected: "0.6", shouldError: false },
    { input: "1,2.5,3", expected: "6.5", shouldError: false },
    { input: "0.1,0.2", expected: "0.3", shouldError: false },
    ...
    { input: "//,\\n.5,10", expected: null, shouldError: true },
    { input: "//,\\n5.,10", expected: null, shouldError: true },
